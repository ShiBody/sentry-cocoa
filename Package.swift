...
let package = Package(
    ...
    targets: [
        .binaryTarget(
                    name: "Sentry",
                    url: "https://github.com/ShiBody/sentry-cocoa/releases/download/8.43.0/Sentry.xcframework.zip",
                    checksum: "18b16b651630b865a91d6cf527ef79363156386e3e8568ae15d5d8718267d535" //Sentry-Static
                ),
        .binaryTarget(
                    name: "Sentry-Dynamic",
                    url: "https://github.com/ShiBody/sentry-cocoa/releases/download/8.43.0/Sentry-Dynamic.xcframework.zip",
